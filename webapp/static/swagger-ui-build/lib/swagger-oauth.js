...
function handleLogin() {
  ...
  //SWAGGER_STUFF:120 only display applicable scopes (will need to pass them into handleLogin)
  ...
  popupDialog.find('button.api-popup-authbtn').click(function() {
    ...
    //SWAGGER_STUFF:90 merge not replace if scheme is different from any existing 
